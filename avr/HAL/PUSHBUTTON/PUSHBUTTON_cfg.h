...
#define PUSHBUTTON_u8NUM_1     ((uint8 ) 1)
#define PUSHBUTTON_u8NUM_2     ((uint8 ) 2)
#define PUSHBUTTON_u8NUM_3     ((uint8 ) 3)
#define PUSHBUTTON_u8NUM_4     ((uint8 ) 4)

#define PUSHBUTTON_MAX_NUM     ((uint8) 5)
